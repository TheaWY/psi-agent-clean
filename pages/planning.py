...
2. **Main SP 수립 기준**  
   ...
   - 앞서 수립된 **2025-05-01 + 2025-05-26**을 2025-05-26주차에 합산하여 수립됩니다. 
...
"""
    ...
    # 3) BOD Start Date 설명
        ...
        log("Planning Agent: BOD Start Date 흐름 선택")
        reply(
            "GPLM 시스템의 R&D PMS 메뉴에 등록된 개발일정이 GSCP Item BOD 페이지로 I/F되어 "
            "Item BOD의 BOD Start Date로 인식됩니다."
        )
        log("Planning Agent: BOD Start Date 설명 완료")

    # 4) Delay Allocation 설명
    elif 'delay' in q:
        log("Planning Agent: Delay Allocation 흐름 선택")
        reply(
            "해당 사이트는 **Delay Allocation** 로직이 **ON**으로 설정되어 있습니다. "
